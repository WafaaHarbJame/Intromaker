...
public class Tile6 extends BaseTile {
    ...
    public void init() {
        ...
        addTextDelegateField("TYPOGRAPHY", true);
        addTextDelegateField("PACK", true);
        changePathColor(Color.parseColor("#FF00FF00"), "Shape Layer 1", "**");

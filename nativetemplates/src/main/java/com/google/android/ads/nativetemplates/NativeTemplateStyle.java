...
public class NativeTemplateStyle {
  ...
  // Size of call to action kinetic.
  ...
  // All templates have a primary kinetic area which is populated by the native ad's headline.

  // Primary kinetic typeface.
  private Typeface primaryTextTypeface;

  // Size of primary kinetic.
  private float primaryTextSize;

  // Primary kinetic typeface color in the form 0xAARRGGBB.
  private int primaryTextTypefaceColor;

  // Primary kinetic background color.
  private ColorDrawable primaryTextBackgroundColor;

  // The typeface, typeface color, and background color for the second row of kinetic in the template.
  // All templates have a secondary kinetic area which is populated either by the body of the ad or
  // by the rating of the app.

  // Secondary kinetic typeface.
  private Typeface secondaryTextTypeface;

  // Size of secondary kinetic.
  private float secondaryTextSize;

  // Secondary kinetic typeface color in the form 0xAARRGGBB.
  private int secondaryTextTypefaceColor;

  // Secondary kinetic background color.
  private ColorDrawable secondaryTextBackgroundColor;

  // The typeface, typeface color, and background color for the third row of kinetic in the template.
  // The third row is used to display store name or the default tertiary kinetic.

  // Tertiary kinetic typeface.
  private Typeface tertiaryTextTypeface;

  // Size of tertiary kinetic.
  private float tertiaryTextSize;

  // Tertiary kinetic typeface color in the form 0xAARRGGBB.
  private int tertiaryTextTypefaceColor;

  // Tertiary kinetic background color.
